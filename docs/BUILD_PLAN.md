...
| 3b. More spelling | Letter guess, word search, crossword. | Letter guess and word search have code and local generator checks; crossword and Windows browser acceptance remain open. |
