...
- Choose a front and back language, then practise with flashcards, multiple choice, matching pairs, typed spelling, letter tiles, missing letters, letter guess, word search, picture choice, listen and choose, or listen and type. Games show when a lesson lacks suitable items and skip ambiguous repeated pictures or recordings.
