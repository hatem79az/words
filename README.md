...
- Letter tiles and missing letters accept suitable single words and keep combined Unicode letters intact. For Letter tiles, choose letters by click or keyboard, or drag them into and within the answer area with a desktop mouse; drag a placed letter back to the tray to remove it. Listen-and-type uses a recording in the answer language; press Play to hear it. Typed spelling, tiles, missing letters, and listen-and-type allow one retry before showing the answer.
