(function (root) {
  ...
  const strings = {
    en: {
      ...
      learnerProgress: 'Learner progress', clearProgress: 'Clear progress', recentRounds: 'Recent rounds',
      noProgress: 'No completed rounds for this lesson yet.',
      progressSummary: 'Completed rounds: {rounds}. Scored answers: {correct} of {total}.',
      progressReviewSummary: 'Completed rounds: {rounds}. Flashcard passes: {reviews}.',
      progressResult: '{score} of {total} correct', progressCards: 'Viewed {total} cards',
      progressLocalNote: 'Progress stays in this browser and is not included in lesson exports.',
      confirmClearProgress: 'Clear progress for this lesson on this browser? The lesson stays intact.',
      progressCleared: 'Lesson progress cleared.', progressStorageUnavailable: 'Progress changes could not be saved in this browser. Practice still works.',
      ...
      wordPattern: 'Word with gaps: {pattern}', assembledWord: 'Your assembled word', selectTiles: 'Choose letters below, or drag them here with a mouse.',
      ...
      selectSentenceChunks: 'Choose chunks below, or drag them here with a mouse.', availableSentenceChunks: 'Available sentence chunks',
    ...
    pl: {
      ...
      learnerProgress: 'Postępy ucznia', clearProgress: 'Wyczyść postępy', recentRounds: 'Ostatnie rundy',
      noProgress: 'Nie ukończono jeszcze żadnej rundy tej lekcji.',
      progressSummary: 'Ukończone rundy: {rounds}. Poprawne odpowiedzi: {correct} z {total}.',
      progressReviewSummary: 'Ukończone rundy: {rounds}. Przejścia przez fiszki: {reviews}.',
      progressResult: 'Poprawne: {score} z {total}', progressCards: 'Obejrzane karty: {total}',
      progressLocalNote: 'Postępy są przechowywane w tej przeglądarce i nie są dołączane do eksportu lekcji.',
      confirmClearProgress: 'Wyczyścić postępy tej lekcji w tej przeglądarce? Sama lekcja pozostanie bez zmian.',
      progressCleared: 'Wyczyszczono postępy lekcji.', progressStorageUnavailable: 'Nie udało się zapisać zmian postępów w tej przeglądarce. Nadal możesz ćwiczyć.',
      ...
      wordPattern: 'Słowo z lukami: {pattern}', assembledWord: 'Ułożone słowo', selectTiles: 'Wybierz litery poniżej lub przeciągnij je tutaj myszą.',
      ...
      selectSentenceChunks: 'Wybierz części poniżej lub przeciągnij je tutaj myszą.', availableSentenceChunks: 'Dostępne części zdania',
    ...
    ar: {
      ...
      learnerProgress: 'تقدّم المتعلّم', clearProgress: 'مسح التقدّم', recentRounds: 'الجولات الأخيرة',
      noProgress: 'لم تُكمل أي جولة في هذا الدرس بعد.',
      progressSummary: 'الجولات المكتملة: {rounds}. الإجابات الصحيحة: {correct} من {total}.',
      progressReviewSummary: 'الجولات المكتملة: {rounds}. مرات مراجعة البطاقات: {reviews}.',
      progressResult: '{score} من {total} صحيحة', progressCards: 'شاهدت {total} بطاقات',
      progressLocalNote: 'يُحفظ التقدّم في هذا المتصفح ولا يُضمّن في ملفات تصدير الدروس.',
      confirmClearProgress: 'هل تريد مسح تقدّم هذا الدرس في هذا المتصفح؟ سيبقى الدرس كما هو.',
      progressCleared: 'مُسح تقدّم الدرس.', progressStorageUnavailable: 'تعذّر حفظ تغييرات التقدّم في هذا المتصفح. يمكنك متابعة التدرّب.',
      ...
      wordPattern: 'الكلمة مع الفراغات: {pattern}', assembledWord: 'الكلمة التي ركّبتها', selectTiles: 'اختر الحروف أدناه أو اسحبها إلى هنا بالماوس.',
      ...
      selectSentenceChunks: 'اختر المقاطع أدناه أو اسحبها إلى هنا بالماوس.', availableSentenceChunks: 'مقاطع الجملة المتاحة',
    ...
    de: {
      ...
      learnerProgress: 'Lernfortschritt', clearProgress: 'Fortschritt löschen', recentRounds: 'Letzte Runden',
      noProgress: 'Für diese Lektion gibt es noch keine abgeschlossenen Runden.',
      progressSummary: 'Abgeschlossene Runden: {rounds}. Richtige Antworten: {correct} von {total}.',
      progressReviewSummary: 'Abgeschlossene Runden: {rounds}. Karteikarten-Durchgänge: {reviews}.',
      progressResult: '{score} von {total} richtig', progressCards: '{total} Karten angesehen',
      progressLocalNote: 'Der Fortschritt bleibt in diesem Browser und ist nicht im Lektionsexport enthalten.',
      confirmClearProgress: 'Fortschritt für diese Lektion in diesem Browser löschen? Die Lektion bleibt erhalten.',
      progressCleared: 'Lektionsfortschritt gelöscht.', progressStorageUnavailable: 'Fortschrittsänderungen konnten in diesem Browser nicht gespeichert werden. Üben ist weiterhin möglich.',
      ...
      wordPattern: 'Wort mit Lücken: {pattern}', assembledWord: 'Dein zusammengesetztes Wort', selectTiles: 'Wähle unten Buchstaben aus oder ziehe sie mit der Maus hierher.',
      ...
      selectSentenceChunks: 'Wähle unten Satzteile oder ziehe sie mit der Maus hierher.', availableSentenceChunks: 'Verfügbare Satzteile',
